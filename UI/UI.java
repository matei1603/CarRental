...
public class UI {
    ...
    public static void printMenu() {
        ...
        System.out.println("10. Print all vehicles which are rented");
        System.out.println("11. Print all vehicles which are not rented");
        System.out.println("12. Print all vehicles with price less than a given value");
        System.out.println("13. Print all vehicles with mileage lower than a given value");
        System.out.println("14. Print all vehicles rented by given type of vehicle");
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.serv.getAllRentedVehicles();
                    break;
                case 11:
                    this.serv.getAllAvailableVehicles();
                    break;
                case 12:
                    this.getAllPriceLower();
                    break;
                case 13:
                    this.getAllMileageLower();
                    break;
                case 14:
                    this.getAllRentedByType();
                    break;
                case 404:
    ...
    private void getAllRentedByType() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the type: ");
        String type = scanner.next();
        this.serv.getAllVehiclesRentedByType(type);
    }

    private void getAllMileageLower() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the mileage: ");
        Integer mileage = scanner.nextInt();
        this.serv.getAllVehiclesWithMileageLowerThan(mileage);
    }

    private void getAllPriceLower() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Enter the price: ");
        Integer price = scanner.nextInt();
        this.serv.getAllVehiclesWithPriceLessThan(price);
    }
    ...
    private Vehicle inputCar() {
        ...
        System.out.println("Enter the mileage: ");
        Integer mileage = scanner.nextInt();
        System.out.println("Enter the isRented: ");
        Boolean isRented = scanner.nextBoolean();
        return new Vehicle(id, name, type, color, year, price, mileage, isRented);
    }
